...
public class UserInputConversionTest {
	...
	public void test() throws NoSuchMethodException, SecurityException,
		...
		assertEquals("The expected the lower bound should be 94133", 94133,
				testSet[0].getLowerBound());
		assertEquals("The expected the upper bound should be 94133", 94133,
				testSet[0].getUpperBound());

		// test the second range
		assertEquals("The expected the lower bound should be 94200", 94200,
				testSet[1].getLowerBound());
		assertEquals("The expected the upper bound should be 94299", 94299,
				testSet[1].getUpperBound());

		// test the third range
		assertEquals("The expected the lower bound should be 94600", 94600,
				testSet[2].getLowerBound());
		assertEquals("The expected the upper bound should be 94699", 94699,
				testSet[2].getUpperBound());
	}
